...
import { back, bleuBack, greenFin, textBlack, bleuDense, maxWidth, contJaune, textBleu, contMarron, backButton, textBlanc, blue2, blue41, blue1 } from '../../components/variables';
...
`
export const IsmaiFormInput = styled.input`
    color:${textBleu};
    position:relative;
    width:10rem;
...
export const IsmaiLink = styled(Link)`
font-size:1.5rem;
height:3rem;
width:70%;
border-radius:3rem;
